  ...
  void _updateLocation(PointerEvent details) {
    setState(() {
      ...
      if (statusTouch1 && statusTouch2) {
        ...
        if (jarak1 > jarak2) {
          result[1] = x;
          result[0] = dataTouch[0];
          //result[0] = dataTouch[0].toDouble();
          // result[0] = jarak1.toDouble();
        }
        if (jarak1 < jarak2) {
          result[0] = x;
          result[1] = dataTouch[1];
          // result[1] = jarak2.toDouble();
        }
        ...
        deltaTouch[0] = data1 - dataTouch[0].toInt();
        ...
        // int data3,data4;
        // if(data1 < data2){data3 = data1;data4=data2;}
        // else{data3 = data2;data4=data1;}
        ...
        print("Data An : " + data1.toInt().toString());
        // }
      }
    });
  }
